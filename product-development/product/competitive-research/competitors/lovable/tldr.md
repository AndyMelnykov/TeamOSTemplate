...
## Overview
AI-first app builder focused on design quality and visual polish.

## Key Strengths
- Beautiful UIs out of the box — strong design system adherence and component quality
- Appeals to non-technical founders who care about aesthetics
- One-click deployment with hosting included
- Custom domain support

## Key Weaknesses
- Limited backend capabilities — generated apps require significant rework beyond simple CRUD
- No robust CI/CD pipeline
- No enterprise features (no SSO, audit logs, SLAs)
